...
<head>
    ...
    {{--
        Overridden from vendor/laravel/telescope/resources/views/layout.blade.php
        ...
        logo/title changed:
          1. Bunny Fonts swapped from Telescope's default Figtree to the same
             ...
             the same way Telescope already loads its own font (a live Bunny
             Fonts CSS URL), not the app's self-hosted Vite-bundled files,
             since Telescope's layout isn't part of the Vite build.
          2. public/css/telescope-theme.css linked *after*
             Telescope::css()'s inlined <style> tags, so it wins the cascade
             on equal-specificity Bootstrap 4 selectors (Telescope's own
    ...
    <link href="https://fonts.bunny.net/css?family=manrope:400,500,600,700|space-grotesk:500,600,700|jetbrains-mono:400,500" rel="stylesheet" />

    {{ Laravel\Telescope\Telescope::css() }}
    <link rel="stylesheet" href="{{ asset('css/telescope-theme.css') }}">
