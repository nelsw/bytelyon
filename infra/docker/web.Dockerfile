...
COPY ./infra/8.5/start-container /usr/local/bin/start-container
COPY ./infra/8.5/supervisord.conf /etc/supervisor/conf.d/supervisord.conf
COPY ./infra/8.5/php.ini /etc/php/8.5/cli/conf.d/99-sail.ini
